...
export const toolMetadatas: ToolMetadata[] = [
  ...
  },
  {
    ...
    category: "utility",
    label: "Chart",
    description: "Generate pie, line, bar, doughnut, radar, polar area, and bubble charts via QuickChart. Supports optional API key for higher rate limits.",
    icon: "bar-chart",
  ...
  {
    nodeRegistry: "objectStorage",
    category: "storage",
    label: "Object Storage",
    description: "Store and retrieve objects in S3, R2, GCS, and Azure Blob with 11 operations: put, read, delete, copy, move, list, metadata, presigned URLs, and existence checks",
    icon: "database",
